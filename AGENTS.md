...
### 4. NEVER change PulseMed root documentation for client-specific content
PulseMed root houses **business infrastructure and base code** only. Client-specific AI instructions, changelogs, and detailed client docs live **inside** each client folder (e.g. `clients/hippreservation/AGENTS.md`, `clients/hippreservation/CHANGELOG.md`).
